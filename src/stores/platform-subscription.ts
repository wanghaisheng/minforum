...
export default class SubscriptionStore {
  ...
  @action newSubscription = async (body: subscriptionProp) => {
    let url = `${API_URL}/transaction/subscription`;
  ...
  @action getSubscription = async (userId: string) => {
    let url = `${API_URL}/platform-subscription/${userId}`;
  ...
  @action getSubscriptions = async () => {
    ...
    let url = `${API_URL}/platform-subscription?page=${this.page}&limit=${this.limit}`;
  ...
  @action searchSubscriptions = async (query: string) => {
    ...
    let url = `${API_URL}/platform-subscription/search?page=${this.page}&limit=${this.limit}&q=${query}`;
